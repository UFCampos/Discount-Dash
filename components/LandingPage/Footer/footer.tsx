...
const Footer =()=>{
    return (
        <footer className="text-gray-900 body-font bg-gray-400 py-2">
  <div className="container px-5 py- mx-auto flex items-center sm:flex-row flex-col">
    ...
    <p className="text-sm text-gray-100 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-400 sm:py-2 sm:mt-0 mt-4"> Follow Us:
      <a href="" className="text-gray-100 ml-1" rel="noopener noreferrer" target="_blank">@discountdash</a>
    </p>
