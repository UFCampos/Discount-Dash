      ...
      <section className={style.profile}>
        <div className={style.head}>
          <div className={style.imgCont}>
            <Image
              src={data?.image ? data?.image : user?.photoUrl}
              alt="img"
              className={style.img}
            />
        ...
        <div className={style.info}>
          <Link href={`/users/profile/${id}/changeName`} className={style.link}>
            Change name
          </Link>
          <Link
          ...
          <Link href={`/users/profile/${id}/myAddress`} className={style.link}>
            My addresses
          </Link>
          ...
          <Link
            href={`/users/profile/${id}/shopHistory`}
            className={style.link}
          >
            Shop history
          </Link>
          <Link href={`/users/profile/${id}/favorites`} className={style.link}>
            My wishlist
          </Link>
        </div>
      </section>
