				...
				<div className='container px-5 py-24 mx-auto '>
					<div className=' lg:w-4/5 mx-auto items-center border border-gray-800 rounded-lg p-2'>
						<div className='lg:w-1/2 lg:h-auto h-64 mx-auto object-cover object-center rounded'>
							<Image alt={data?.name} className='w-full h-full' src={data?.image} width={350} height={350} />
						</div>
						<div className='lg:w-1/2 mx-auto lg:pl-10 lg:py-6 mt-6 lg:mt-0'>
							<h2 className='text-sm title-font text-gray-500 tracking-widest'>Food</h2>
							<h1 className='text-gray-900 text-3xl title-font font-medium mb-1'>{data?.name}</h1>
							<h2 className='text-sm title-font text-gray-700 tracking-widest'>{data?.brand}</h2>
                  ...
                  vence en 5 dias
							...
							<p className='leading-relaxed'> hamburguesa con queso chedar, dos medallones de carne de 250g salsa de la casa, cebolla, lechuga, tomate y extra papas  </p>
							...
							<div className='flex'>
								...
								<button className='rounded-full w-10 h-10 bg-gray-600 p-0 border-0 inline-flex items-center justify-center text-gray-900 ml-4'>
									<Image className='w-7 h-7' src='/carrito.png' width={350} height={350} alt='carrito' />
								</button>
							</div>
						</div>
					</div>
