...
export const RegisterMarketsForm = () => {
  ...
  const disabledButton = () => {
    if (section === 1) {
      const validateSection = Object.values(errorsMarket)?.some(
        (value) => value !== ""
      );
      return validateSection;
    }
    if (section === 2) {
      const validateLocation = Object.values(locationError).some(
        (value) => value !== ""
      );
      return validateLocation;
    }
    if (section === 3) {
      const validateFacture = Object.values(factureError).some(
        (value) => value !== ""
      );
      return validateFacture;
    }
    if (section === 4) {
      const validateLogin = Object.values(loginError).some(
        (value) => value !== ""
      );
  ...
  return (
    <section className={style.contForm}>
      <div className={style.infoCont}>
        ...
        {section === 3 && (
          <FactureInfo
            valueState={factureInfo}
            handleChange={handleChangeFacture}
            errors={factureError}
          />
        )}
        {section === 4 && (
          <LoginInfo
            valueState={loginInfo}
      ...
      <div className={style.buttons}>
        ...
        {section !== 4 && (
          <button
            ...
            onClick={() => handleSection("continue")}
          >
            Continue
          </button>
        )}
        {section === 4 && (
          <button
            ...
            onClick={() => handleSubmit(dataMarket)}
          >
            Register
          </button>
        )}
